...
public interface IHolidaysCalendar
{
    ...
    /// <summary>
    ///   Gets the next working day after specified <param name="date" />.
    /// </summary>
    ...
    /// <summary>
    ///   Determines whether the specified <param name="date" /> is holiday.
    /// </summary>
    /// <param name="date"> The date to check for. </param>
    ...
    /// <summary>
    ///   Determines whether the specified date is a weekend, taking into account working weekends.
    /// </summary>
    /// <param name="date"> The date to check for. </param>
    ...
    /// <summary>
    ///   Determines whether the specified <param name="date" /> is working weekend.
    /// </summary>
    /// <param name="date"> The date to check for. </param>
